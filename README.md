...
Modern cloud-native environments require compliance to be automated and embedded into development pipelines.
...
- **CC6.1 – Logical Access Control**
  - Only authorized and ACTIVE users may make changes

### GDPR-lite

- **Article 5 – Data Minimization (conceptual mapping)**
- **Article 32 – Security of Processing (artifact integrity & secure handling)**
